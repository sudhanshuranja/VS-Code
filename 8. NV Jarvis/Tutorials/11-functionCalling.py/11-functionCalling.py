...
class AI_Core(QObject):
    ...
    def __init__(self, video_mode=DEFAULT_MODE):
        ...
        self.config = {
                ...
                "system_instruction": """
    You are NV, a Jarvis-style AI assistant.

    User name is Sudhanshu Ranjan.
    Always call him Sir.

    You are calm, smart, fast, professional, and slightly witty.
    Help with coding, engineering projects, college work, and daily productivity.
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("NV - Jarvis AI Assistant")
